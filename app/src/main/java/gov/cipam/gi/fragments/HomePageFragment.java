...
,GIAdapter.setOnGIClickListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        rvTop = view.findViewById(R.id.recycler_gi);
        ...
        startSnapHelper2.attachToRecyclerView(rvTop);
        ...
        rvTop.setAdapter(new GIAdapter(mDisplayCategoryList,getContext(),this));
